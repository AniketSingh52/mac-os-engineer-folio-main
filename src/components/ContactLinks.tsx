...
const contactLinks = [
  ...
  //   icon: Instagram,
  //   color: "from-pink-600 via-pink-800 to-blue-600",
  //   description: "Social Media"
  // },
  {
    name: "Email",
    url: "mailto:walfra52777@gmail.com", // Replace with your actual email
    icon: Mail, // Assuming you're importing `Mail` from lucide-react or another icon lib
      ...
      {contactLinks.map((link, index) => (
        ...
        >
          <div className="flex items-center space-x-4">
            <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${link.color} flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}>
...
<div className="glass-card p-6 rounded-xl border border-green-500 text-center  space-y-6">
  ...
  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm md:text-base font-medium">
    ...
    <div className="glass-card p-6 rounded-xl hover:scale-[1.02] transition-all duration-300 group ">
      <p className="text-gradient t font-bold">Response Time</p>
